"""Non-destructive archive copier for chat session 20260714_031854_c2a49e.
...
for record_path in skill_records:
    ...
    args = obj.get("parsed_arguments") or {}
...
receipt_path = write_exclusive(
    ROOT / "manifests/COPY_RECEIPT_v1.json",
