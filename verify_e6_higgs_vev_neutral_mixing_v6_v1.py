...
OUTPUT_JSON = ROOT / "verify_e6_higgs_vev_neutral_mixing_v6_v1.json"
OUTPUT_MD = ROOT / "verify_e6_higgs_vev_neutral_mixing_v6_v1.md"
...
def main() -> None:
    ...
    source_tokens = {
        ...
        "full neutral matrix": r"\mathcal{M}_{\textrm{neutral}}",
    ...
    output = {
        "schema": "verify-e6-higgs-vev-neutral-mixing-v6/v1",
        "status": "PASS",
