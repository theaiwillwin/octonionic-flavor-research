...
TEXT = ROOT / "build_v3" / "main_v3_pdftotext_v4.txt"
CONTACT = ROOT / "manuscript_contact_sheet_v4.png"
FIRST = ROOT / "inspection_title_page_v4.png"
GATE = ROOT / "inspection_gate_figure_page_v4.png"
ANGLES = ROOT / "inspection_angle_figure_page_v4.png"
APPENDIX = ROOT / "inspection_e6_appendix_page_v4.png"
OUTPUT_JSON = ROOT / "publication_verification_v4.json"
OUTPUT_MD = ROOT / "PUBLICATION_VERIFICATION_v4.md"
...
def main() -> int:
    ...
    payload = {
        "schema": "unified-flavor-arxiv-publication-verification/v4",
