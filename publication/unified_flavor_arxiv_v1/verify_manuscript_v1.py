...
TEXT = ROOT / "build_v3" / "main_v3_pdftotext_v1.txt"
CONTACT = ROOT / "manuscript_contact_sheet_v1.png"
FIRST = ROOT / "inspection_title_page_v1.png"
GATE = ROOT / "inspection_gate_figure_page_v1.png"
ANGLES = ROOT / "inspection_angle_figure_page_v1.png"
APPENDIX = ROOT / "inspection_e6_appendix_page_v1.png"
OUTPUT_JSON = ROOT / "publication_verification_v1.json"
OUTPUT_MD = ROOT / "PUBLICATION_VERIFICATION_v1.md"
...
def main() -> int:
    ...
    expected_phrases = [
        "Finite Predictivity Gates for Target-Free G2 Flavor Dynamics",
    ...
    assertions = {
        ...
        "bibtex_log_has_seven_entries": bbl_text.count("\\bibitem") == 6,
    ...
    payload = {
        "schema": "unified-flavor-arxiv-publication-verification/v1",
    ...
    OUTPUT_MD.write_text(
        "\n".join(
            [
                ...
                f"- cited bibliography entries: {bbl_text.count('\\\\bibitem')}",
