...
TEX = ROOT / "main_v4.tex"
BIB = ROOT / "references_v3.bib"
PDF = ROOT / "build_v4" / "main_v4.pdf"
LOG = ROOT / "build_v4" / "main_v4.log"
BBL = ROOT / "build_v4" / "main_v4.bbl"
TEXT = ROOT / "build_v4" / "main_v4_pdftotext_v5.txt"
CONTACT = ROOT / "manuscript_contact_sheet_v5.png"
FIRST = ROOT / "inspection_title_page_v5.png"
GATE = ROOT / "inspection_gate_figure_page_v5.png"
ANGLES = ROOT / "inspection_angle_figure_page_v5.png"
APPENDIX = ROOT / "inspection_appendix_page_v5.png"
OUTPUT_JSON = ROOT / "publication_verification_v5.json"
OUTPUT_MD = ROOT / "PUBLICATION_VERIFICATION_v5.md"
...
def main() -> int:
    ...
    expected_phrases = [
        "Reachability Is Not Selection in Target-Free",
        "68 branches pass a strict stationarity and stability cut",
        "none lies inside all three NuFIT 6.0 three-sigma angle intervals",
        "22.62",
        "nuclear norm is nonsmooth",
        "surjective onto U(3)",
        "2.1768243",
        "not a global no-go theorem",
    ]
    phrase_checks = {phrase: phrase in normalized_text for phrase in expected_phrases}
    ...
    page_targets = {
        ...
        "appendix": next(
            index
            for index, text in enumerate(page_texts)
            if "Numerical verification and artifact ledger" in text
        ),
    }
    ...
    assertions = {
        ...
        "pdf_metadata_title_present": "Reachability Is Not Selection" in metadata.get("title", ""),
    ...
    # All six bibliography entries are cited in the current manuscript.
    passed = all(assertions.values())
    payload = {
        "schema": "unified-flavor-arxiv-publication-verification/v5",
        ...
        "sha256": {
            ...
            BIB.name: sha256(BIB),
            PDF.name: sha256(PDF),
            "claim_ledger_v2.json": sha256(ROOT / "claim_ledger_v2.json"),
        },
