...
PDF = ROOT / "build_v5" / "main_v5.pdf"
LOG = ROOT / "build_v5" / "main_v5.log"
BBL = ROOT / "build_v5" / "main_v5.bbl"
TEXT = ROOT / "build_v5" / "main_v5_pdftotext_v7.txt"
CONTACT = ROOT / "manuscript_contact_sheet_v7.png"
FIRST = ROOT / "inspection_title_page_v7.png"
GATE = ROOT / "inspection_gate_figure_page_v7.png"
ANGLES = ROOT / "inspection_angle_figure_page_v7.png"
APPENDIX = ROOT / "inspection_appendix_page_v7.png"
OUTPUT_JSON = ROOT / "publication_verification_v7.json"
OUTPUT_MD = ROOT / "PUBLICATION_VERIFICATION_v7.md"
...
def main() -> int:
    ...
    payload = {
        "schema": "unified-flavor-arxiv-publication-verification/v7",
