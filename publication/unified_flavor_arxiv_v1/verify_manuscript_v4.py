...
TEXT = ROOT / "build_v3" / "main_v3_pdftotext_v3.txt"
CONTACT = ROOT / "manuscript_contact_sheet_v3.png"
FIRST = ROOT / "inspection_title_page_v3.png"
GATE = ROOT / "inspection_gate_figure_page_v3.png"
ANGLES = ROOT / "inspection_angle_figure_page_v3.png"
APPENDIX = ROOT / "inspection_e6_appendix_page_v3.png"
OUTPUT_JSON = ROOT / "publication_verification_v3.json"
OUTPUT_MD = ROOT / "PUBLICATION_VERIFICATION_v3.md"
...
def main() -> int:
    ...
    payload = {
        "schema": "unified-flavor-arxiv-publication-verification/v3",
